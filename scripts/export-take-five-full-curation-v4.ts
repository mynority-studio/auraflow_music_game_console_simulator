...
const logPath = resolve(outputDir, 'take-five-full-curation-v4.notes.json');
...
writeFileSync(logPath, `${JSON.stringify({
  schemaVersion: 1,
  status: 'full-span event-level A/B candidate after evidence-led final E4 duration review; not approved and not the product baseline',
  source: score.source,
  evidence: {
