...
export const QN_PARTICIPANT_ORDER: BandParticipantRole[] = ['keyboardist', 'bassist', 'drummer', 'guitarist', 'synthPlayer', 'leadPlayer'];

/** participant 中文显示名(UI roster/toggle 用)。 */
export const QN_PARTICIPANT_LABEL: Record<BandParticipantRole, string> = {
  keyboardist: '键盘手', bassist: '贝斯手', drummer: '鼓手', guitarist: '吉他手', synthPlayer: '合成/氛围', leadPlayer: '主奏',
};
