 ...
 *
 * 0.10 lets Phase 2 Lerdahl-derived Mixolydian / Lydian gravity
 * actually fire in auto-mode songs (~1 in 10 songs picks one of seven
 * EXOTIC_MODES). The remaining six (Dorian / Phrygian / Locrian /
 * Harmonic Minor / Melodic Minor) keep hand-tuned modal-flavor
 * gravity — none degrade under exotic exposure since their tables are
 * already complete.
 *
