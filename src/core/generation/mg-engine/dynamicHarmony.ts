...
export const DYNAMIC_TSD_DICTIONARY: Record<string, Record<TSD_Func, DynamicRule[]>> = {
  POP: {
    D: [
      { target: 'MajorTarget', levels: { 0: ['7', 'sus4'], 1: ['9', '9sus4'], 2: ['11', '13'] } },
      { target: 'MinorTarget', levels: { 0: ['7'], 1: ['7sus4'], 2: ['7b13'] } },
      { target: 'Deceptive',   levels: { 0: ['sus4'], 1: ['9sus4'], 2: ['11'] } },
      { target: 'Default',     levels: { 0: ['7'], 1: ['7'], 2: ['9'] } },
    ],
    S: [
