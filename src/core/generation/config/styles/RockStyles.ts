...
export const PopRockStyle: StyleConfig = {
    ...
    orchestration: {
        melodyInstruments: ['Overdriven_Guitar', 'Overdriven_Guitar', 'Electric_Guitar_Clean', 'Rock_Organ', 'Harmonica', 'Tenor_Sax'],
        chordInstruments: ['Overdriven_Guitar', 'Overdriven_Guitar', 'Distortion_Guitar', 'Electric_Guitar_Clean'],
        bassInstruments: ['Electric_Bass_Pick', 'Electric_Bass_Finger', 'Slap_Bass_1'],
        drumInstruments: ['Standard_DrumKit', 'Standard_DrumKit', 'Room_DrumKit'],
        counterMelodyInstruments: ['Rock_Organ', 'Rock_Organ', 'Electric_Guitar_Clean', 'Harmonica', 'Tenor_Sax'],
