...
const POP_FULL: Section[] = [
  ...
  { id: 'build1', role: 'bridge', harmonyRole: 'bridge', functionTag: 'build', bars: 4, repeatGroup: 'BLD', hookPolicy: 'none' },
  ...
  { id: 'build2', role: 'bridge', harmonyRole: 'bridge', functionTag: 'build', bars: 4, repeatGroup: 'BLD', hookPolicy: 'none' },
  { id: 'chorus2', role: 'chorus', harmonyRole: 'chorus', functionTag: 'hook', bars: 8, repeatGroup: 'C', hookPolicy: 'main' },
  { id: 'bridge', role: 'bridge', harmonyRole: 'bridge', functionTag: 'breakdown', bars: 8, hookPolicy: 'none' },
...
const RNB_FORM: Section[] = [
  ...
  { id: 'verse1', role: 'verse', harmonyRole: 'verse', functionTag: 'story', bars: 8, repeatGroup: 'V', hookPolicy: 'light' },
  { id: 'preHook1', role: 'bridge', harmonyRole: 'bridge', functionTag: 'build', bars: 4, repeatGroup: 'PRE', hookPolicy: 'none' },
  { id: 'hook1', role: 'chorus', harmonyRole: 'chorus', functionTag: 'hook', bars: 8, repeatGroup: 'H', hookPolicy: 'call-response' },
  { id: 'verse2', role: 'verse', harmonyRole: 'verse', functionTag: 'story', bars: 8, repeatGroup: 'V', hookPolicy: 'light' },
  { id: 'preHook2', role: 'bridge', harmonyRole: 'bridge', functionTag: 'build', bars: 4, repeatGroup: 'PRE', hookPolicy: 'none' },
  { id: 'hook2', role: 'chorus', harmonyRole: 'chorus', functionTag: 'hook', bars: 8, repeatGroup: 'H', hookPolicy: 'call-response' },
  { id: 'breakdown', role: 'bridge', harmonyRole: 'bridge', functionTag: 'breakdown', bars: 8, hookPolicy: 'none' },
