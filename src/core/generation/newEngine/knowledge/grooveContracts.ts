...
const DRUM_POP_RADIO: GrooveDrumIntent = { kitProgram: 8, timekeeperFamily: 'pop-backbeat', liftFamily: 'pop-backbeat', pickupFamily: 'pop-backbeat', breakdownFamily: 'ballad-halftime' };
const DRUM_CITYPOP: GrooveDrumIntent = { kitProgram: 8, timekeeperFamily: 'citypop-syncopated-boogie', liftFamily: 'citypop-disco-boogie', pickupFamily: 'citypop-disco-boogie', breakdownFamily: 'citypop-syncopated-boogie' };
const DRUM_JPOP: GrooveDrumIntent = { kitProgram: 8, timekeeperFamily: 'jpop-driving-8ths', liftFamily: 'jpop-driving-8ths', pickupFamily: 'jpop-driving-8ths', breakdownFamily: 'pop-backbeat' };
const DRUM_POP_BALLAD: GrooveDrumIntent = { kitProgram: 8, timekeeperFamily: 'ballad-halftime', liftFamily: 'ballad-halftime', pickupFamily: 'ballad-halftime', breakdownFamily: 'ballad-halftime' };
const DRUM_808_LOFI: GrooveDrumIntent = { kitProgram: 25, timekeeperFamily: 'tr808-lofi-boombap', liftFamily: 'tr808-lofi-boombap', pickupFamily: 'tr808-lofi-boombap', breakdownFamily: 'tr808-lofi-minimal' };
const DRUM_808_LOFI_DUSTY: GrooveDrumIntent = { kitProgram: 25, timekeeperFamily: 'tr808-lofi-dusty-break', liftFamily: 'tr808-lofi-boombap', pickupFamily: 'tr808-lofi-dusty-break', breakdownFamily: 'tr808-lofi-minimal' };
const DRUM_808_RNB: GrooveDrumIntent = { kitProgram: 25, timekeeperFamily: 'tr808-rnb-pocket', liftFamily: 'tr808-rnb-pocket', pickupFamily: 'tr808-rnb-pocket', breakdownFamily: 'tr808-rnb-pocket' };
const DRUM_808_DILLA: GrooveDrumIntent = { kitProgram: 25, timekeeperFamily: 'tr808-dilla-pocket', liftFamily: 'tr808-dilla-pocket', pickupFamily: 'tr808-dilla-pocket', breakdownFamily: 'tr808-rnb-pocket' };
const DRUM_RNB_GOSPEL: GrooveDrumIntent = { kitProgram: 8, timekeeperFamily: 'rnb-gospel-triplet', liftFamily: 'rnb-gospel-triplet', pickupFamily: 'rnb-gospel-triplet', breakdownFamily: 'rnb-gospel-triplet' };
const DRUM_RNB_MOTOWN: GrooveDrumIntent = { kitProgram: 8, timekeeperFamily: 'pop-backbeat', liftFamily: 'pop-backbeat', pickupFamily: 'pop-backbeat', breakdownFamily: 'pop-backbeat' };
const DRUM_808_TRAP: GrooveDrumIntent = { kitProgram: 25, timekeeperFamily: 'tr808-trap-soul-halftime', liftFamily: 'tr808-trap-soul-halftime', pickupFamily: 'tr808-trap-soul-halftime', breakdownFamily: 'tr808-trap-soul-halftime' };
const DRUM_JAZZ_SWING: GrooveDrumIntent = { kitProgram: 40, timekeeperFamily: 'jazz-swing-ride', liftFamily: 'jazz-bebop-comping', pickupFamily: 'jazz-swing-ride', breakdownFamily: 'jazz-swing-ride' };
const DRUM_SMOOTH_JAZZ: GrooveDrumIntent = { kitProgram: 8, timekeeperFamily: 'smooth-jazz-backbeat', liftFamily: 'smooth-jazz-backbeat', pickupFamily: 'smooth-jazz-backbeat', breakdownFamily: 'smooth-jazz-backbeat' };
const DRUM_JAZZ_BALLAD: GrooveDrumIntent = { kitProgram: 40, timekeeperFamily: 'jazz-brush-ballad', liftFamily: 'jazz-brush-ballad', pickupFamily: 'jazz-brush-ballad', breakdownFamily: 'jazz-brush-ballad' };
const DRUM_JAZZ_BOSSA: GrooveDrumIntent = { kitProgram: 40, timekeeperFamily: 'jazz-bossa', liftFamily: 'jazz-bossa', pickupFamily: 'jazz-bossa', breakdownFamily: 'jazz-bossa' };
const DRUM_ACG_ROOM: GrooveDrumIntent = { kitProgram: 8, timekeeperFamily: 'ballad-halftime', liftFamily: 'jpop-driving-8ths', pickupFamily: 'pop-backbeat', breakdownFamily: 'ballad-halftime' };

const POP_GROOVES: GrooveContract[] = [
  { id: 'pop_radio_straight', name: 'POP radio straight grid', style: 'POP', weight: 4, grid: 'straight', density: 'medium', compSwingRatio: 0.5, melodySwingRatio: 0.5, bassPocketMs: [0, 2], chordPocketMs: [0, 4], melodyStrongPocketMs: [0, 0], melodyWeakPocketMs: [0, 0], velocityHumanize: 0.03, accentPattern: [1.0, 0.9, 1.0, 0.9], articulation: 'legato', drum: DRUM_POP_RADIO, preferredTextureCases: ['Block_Chord', 'Broken_Chord', 'Pop_Broken_8ths_Sync', 'Pop_Alberti_Lyrical'], allowedTextureCases: ['Block_Chord', 'Broken_Chord', 'Pop_Broken_8ths_Sync', 'Pop_Alberti_Lyrical', 'Pop_Anthem_Pulse', 'Pop_Half_Arp_Sweep', 'Arpeggio_Flow'], forbiddenTextureCases: ['Ambient_Reverse_Swell', 'Low_Pedal_Color_Wash'] },
  { id: 'pop_citypop_boogie', name: 'POP CityPop boogie pocket', style: 'POP', weight: 5, grid: 'straight', density: 'active', compSwingRatio: 0.5, melodySwingRatio: 0.5, bassPocketMs: [-2, 2], chordPocketMs: [0, 6], melodyStrongPocketMs: [0, 2], melodyWeakPocketMs: [0, 6], velocityHumanize: 0.05, accentPattern: [1.04, 0.9, 1.02, 0.9], articulation: 'legato', drum: DRUM_CITYPOP, pushProbability: 0.1, preferredTextureCases: ['Pop_Broken_8ths_Sync', 'Pop_Wave_16ths', 'Soft_Guitar_Pluck_8ths', 'Pop_Rnb_Expensive_Add9_Quartal'], allowedTextureCases: ['Pop_Broken_8ths_Sync', 'Pop_Wave_16ths', 'Pop_Anthem_Pulse', 'Pop_Half_Arp_Sweep', 'Pop_Piano_Arp_16ths', 'Soft_Guitar_Pluck_8ths', 'Pop_Rnb_Expensive_Add9_Quartal', 'Block_Chord', 'Broken_Chord'], forbiddenTextureCases: ['Ambient_Reverse_Swell', 'Low_Pedal_Color_Wash'] },
  { id: 'pop_jpop_push_8ths', name: 'POP/JPOP forward eighths', style: 'POP', weight: 3, grid: 'straight', density: 'active', compSwingRatio: 0.5, melodySwingRatio: 0.5, bassPocketMs: [-2, 2], chordPocketMs: [-2, 3], melodyStrongPocketMs: [0, 0], melodyWeakPocketMs: [0, 0], velocityHumanize: 0.04, accentPattern: [1.04, 0.92, 1.02, 0.9], articulation: 'legato', drum: DRUM_JPOP, pushProbability: 0.12, preferredTextureCases: ['Pop_Broken_8ths_Sync', 'Pop_Wave_16ths', 'Pop_Anthem_Pulse', 'Pop_Half_Arp_Sweep'], allowedTextureCases: ['Pop_Broken_8ths_Sync', 'Pop_Wave_16ths', 'Pop_Anthem_Pulse', 'Pop_Half_Arp_Sweep', 'Pop_Piano_Arp_16ths', 'Soft_Guitar_Pluck_8ths'], forbiddenTextureCases: ['Ambient_Pad_Breath', 'Ambient_Reverse_Swell', 'Low_Pedal_Color_Wash'] },
  { id: 'pop_ballad_halftime', name: 'POP ballad half-time', style: 'POP', weight: 2, grid: 'straight', density: 'sparse', compSwingRatio: 0.5, melodySwingRatio: 0.5, bassPocketMs: [0, 4], chordPocketMs: [2, 12], melodyStrongPocketMs: [0, 0], melodyWeakPocketMs: [0, 0], velocityHumanize: 0.07, accentPattern: [1.0, 0.86, 0.98, 0.84], articulation: 'legato', drum: DRUM_POP_BALLAD, preferredTextureCases: ['HalfTime_Emotional_Pulse', 'Lyrical_Felt_Piano_Sparse', 'Lyrical_10th_Broken', 'Piano_Question_Answer'], allowedTextureCases: ['HalfTime_Emotional_Pulse', 'Lyrical_Felt_Piano_Sparse', 'Lyrical_10th_Broken', 'Piano_Question_Answer', 'Pop_Ballad_158_Sweep', 'Piano_Wide_Color_Motion', 'Ambient_Pad_Breath', 'Low_Pedal_Color_Wash'], forbiddenTextureCases: ['Pop_Wave_16ths', 'Pop_Anthem_Pulse'] },
];

const LOFI_GROOVES: GrooveContract[] = [
  { id: 'lofi_lazy_dilla', name: 'LOFI lazy Dilla pocket', style: 'LOFI', weight: 4, grid: 'dilla', density: 'medium', compSwingRatio: 0.58, melodySwingRatio: 0.54, bassPocketMs: [-2, 5], chordPocketMs: [4, 20], melodyStrongPocketMs: [0, 5], melodyWeakPocketMs: [4, 18], velocityHumanize: 0.12, accentPattern: [0.96, 0.88, 0.94, 0.86], articulation: 'legato', drum: DRUM_808_LOFI, preferredTextureCases: ['Piano_Lofi_Dusty_Chops', 'Piano_CommonTone_Soft_Roll', 'Piano_Lofi_Late_Chord_Answer'], allowedTextureCases: ['Piano_Lofi_Dusty_Chops', 'Piano_CommonTone_Soft_Roll', 'Piano_Lofi_Late_Chord_Answer', 'Piano_HalfTime_Soft_Pulse', 'Piano_Lofi_Tape_Wobble_Arp'], forbiddenTextureCases: ['Piano_Wide_Color_Motion'] },
  { id: 'lofi_tape_late_chords', name: 'LOFI tape-late chord answers', style: 'LOFI', weight: 3, grid: 'straight', density: 'sparse', compSwingRatio: 0.5, melodySwingRatio: 0.5, bassPocketMs: [-2, 4], chordPocketMs: [8, 26], melodyStrongPocketMs: [0, 4], melodyWeakPocketMs: [6, 18], velocityHumanize: 0.15, accentPattern: [0.94, 0.86, 0.92, 0.84], articulation: 'legato', drum: DRUM_808_LOFI_DUSTY, preferredTextureCases: ['Piano_Lofi_Late_Chord_Answer', 'Piano_Ambient_Sustain_Wash', 'Piano_Lofi_OneShot_Space'], allowedTextureCases: ['Piano_Lofi_Late_Chord_Answer', 'Piano_Ambient_Sustain_Wash', 'Piano_Lofi_OneShot_Space', 'Piano_CommonTone_Soft_Roll', 'Piano_Wide_Color_Motion'], forbiddenTextureCases: ['Piano_Lofi_Dusty_Chops'] },
  { id: 'lofi_halftime_dusty', name: 'LOFI half-time dusty pulse', style: 'LOFI', weight: 2, grid: 'dilla', density: 'sparse', compSwingRatio: 0.56, melodySwingRatio: 0.53, bassPocketMs: [-3, 5], chordPocketMs: [5, 20], melodyStrongPocketMs: [0, 4], melodyWeakPocketMs: [5, 16], velocityHumanize: 0.13, accentPattern: [0.95, 0.84, 0.91, 0.82], articulation: 'legato', drum: DRUM_808_LOFI, preferredTextureCases: ['Piano_HalfTime_Soft_Pulse', 'Piano_Emo_Broken_10th', 'Piano_Lofi_Tape_Wobble_Arp'], allowedTextureCases: ['Piano_HalfTime_Soft_Pulse', 'Piano_Emo_Broken_10th', 'Piano_Lofi_Tape_Wobble_Arp', 'Piano_Lofi_OneShot_Space', 'Piano_Ambient_Sustain_Wash'], forbiddenTextureCases: ['Piano_Wide_Color_Motion'] },
];
