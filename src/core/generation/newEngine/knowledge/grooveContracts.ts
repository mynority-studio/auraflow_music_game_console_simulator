...
const DRUM_POP_BALLAD = drumIntent(8, { timekeeperFamily: 'ballad-halftime', liftFamily: 'ballad-halftime', pickupFamily: 'ballad-halftime', breakdownFamily: 'ballad-halftime' }, { light: 'pop-snare-pickup', strong: 'pop-tom-build', pickup: 'pop-tom-build' }, 'kick-crash', 'bass', 'backbeat', POP_ROCK_FILL_VOCABULARY_ID);
