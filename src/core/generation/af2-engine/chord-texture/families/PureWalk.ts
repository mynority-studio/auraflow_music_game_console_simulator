...
import type { NoteEvent, PureWalkParams, BassOffsetName } from '../types';
...
export function applyPureWalk(
    ...
    // 重复模式:若 grid_points 总长 < duration,循环填满
    const totalGridDuration = params.grid_points[params.grid_points.length - 1] + 0.5;
