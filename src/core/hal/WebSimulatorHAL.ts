 ...
 * and Dream 5504 Web MIDI routing to simulate the physical hardware.
 * 
...
export class WebSimulatorHAL implements ILedMatrix, ITouchPad, IAudioOut, ISystemTimer {
    ...
    // --- IAudioOut Implementation (Simulated via Dream 5504 Web MIDI) ---
    public playNote(pitch: number, velocity: number, durationMs: number, instrumentId: number): void {
        // In the simulator, AudioEngine currently handles Dream 5504 MIDI directly.
        // Future refactor: Move MIDI routing here to fully decouple AudioEngine.
