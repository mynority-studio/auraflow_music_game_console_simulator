...
|---|---|---|---|---|
| Perfect | ±80ms | 贴谱发声 | 重拍手 GM39 v84 | 律光+2,combo+1 |
| 普通 | ±220ms | 贴谱发声 | 轻拍手 GM39 v76 | 律光+1,combo+1 |
| 按偏 | ±380ms | **不发声** | 鼓边边击 GM37 v72(即刻) | combo 清零,**断**律光音轨 |
...
- **音量**(2026-08-25 裁定,撤销 127 对比档):Aura Key 期间接管通道 CC7=100,
  与生成 lead 持平;仍显式补发防 voice setup 覆盖。屏幕键默认力度 80(2026-08-25 裁定,整体力度压到 80 档)。
